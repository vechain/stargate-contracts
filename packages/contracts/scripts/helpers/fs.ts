...
async function saveContractsToFile(
  ...
  libraries: {
    StargateNFTClockLib: string;
    StargateNFTSettingsLib: string;
    StargateNFTTokenLib: string;
    StargateNFTMintingLib: string;
    StargateNFTVetGeneratedVthoLib: string;
    StargateNFTLevelsLib: string;
  }
): Promise<void> {
