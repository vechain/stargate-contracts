...
import IProtocolStakerJson from "./artifacts/contracts/interfaces/IProtocolStaker.sol/IProtocolStaker.json";
export { IProtocolStakerJson };

export {
    StargateNFT__factory,
    StargateDelegation__factory,
    NodeManagementV3__factory,
    Stargate__factory,
    IProtocolStaker__factory,
    ThunderFactory__factory,
