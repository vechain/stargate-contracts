...
import { IStargateDelegation } from "./IStargateDelegation.sol";
    ...
    IStargateDelegation
{
    ...
    function _calculateLastCompletedPeriodEndBlock(
        ...
        // mainnet hot fix for the active delegations to return the correct end block
        // if the delegation is not active, we return the last delegation end block
        // if the delegation is active we return the rewardsAccumulation end block
        // directly without any other calculations
        if (!isDelegationActive(_tokenId)) {
            ...
            return $.rewardsAccumulationEndBlock;
        }
    }
