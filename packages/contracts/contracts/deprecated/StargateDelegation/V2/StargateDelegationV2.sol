...
contract StargateDelegationV2 is
    AccessControlUpgradeable,
    ReentrancyGuardUpgradeable,
    UUPSUpgradeable,
    IStargateDelegationV2
{
    ...
    function initialize(StargateDelegationInitParams memory _initParams) external initializer {
        ...
        $.stargateNFT = IStargateNFTV1(_initParams.stargateNFT);
    ...
    function getStargateNFTContract() external view returns (IStargateNFTV1) {
