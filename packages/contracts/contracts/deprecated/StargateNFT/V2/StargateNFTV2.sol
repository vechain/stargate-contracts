...
import { IStargateNFTV2 as IStargateNFT } from "./IStargateNFTV2.sol";
import { ITokenAuction } from "../../../interfaces/ITokenAuction.sol";
import { IStargateDelegationV2 as IStargateDelegation } from "../../StargateDelegation/V2/IStargateDelegationV2.sol";
    ...
    IStargateNFT
{
    ...
    function getWhitelistEntry(
        address _owner
    ) external view returns (uint256 tokenId, uint8 levelId) {
        DataTypes.StargateNFTStorage storage $ = _getStargateNFTStorage();
