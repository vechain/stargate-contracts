...
import { INodeManagementV4 } from "./INodeManagement/INodeManagementV4.sol";
import { IStargateNFTV2 as IStargateNFT } from "../StargateNFT/V2/IStargateNFTV2.sol";
import { DataTypesV2 as DataTypes } from "../StargateNFT/V2/libraries/DataTypesV2.sol";
 ...
 *
 * ------------------------ Version 4 ------------------------
 * - Pause and deprecate the contract
 */
contract NodeManagementV4 is
    INodeManagementV4,
    ...
    PausableUpgradeable
{
    ...
    function initializeV4() external onlyRole(UPGRADER_ROLE) reinitializer(4) {
        __Pausable_init();
        _pause();
    }
    // ---------- Setters ---------- //
     ...
     */
    function delegateNode(address delegatee, uint256 nodeId) public virtual whenNotPaused {
        NodeManagementStorage storage $ = _getNodeManagementStorage();
     ...
     */
    function removeNodeDelegation(uint256 nodeId) public virtual whenNotPaused {
        NodeManagementStorage storage $ = _getNodeManagementStorage();
